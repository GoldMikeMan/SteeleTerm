...
namespace Windows.Win32
{
	...
	internal static partial class PInvoke
	{
		...
		/// <remarks>
		/// <para><see href="https://learn.microsoft.com/windows/win32/api/oleauto/nf-oleauto-sysfreestring">Learn more about this API from learn.microsoft.com</see>.</para>
		/// </remarks>
		[DllImport("OLEAUT32.dll", ExactSpelling = true),DefaultDllImportSearchPaths(DllImportSearchPath.System32)]
		internal static extern void SysFreeString([Optional] winmdroot.Foundation.BSTR bstrString);
	}
}
