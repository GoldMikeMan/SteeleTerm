...
namespace Windows.Win32
{
	namespace System.Com
	{
		...
		/// <remarks>
		/// <para><see href="https://learn.microsoft.com/windows/win32/api/objidl/ns-objidl-statstg">Learn more about this API from learn.microsoft.com</see>.</para>
		/// </remarks>
		...
		internal partial struct STATSTG
		{
			...
			/// <para><see href="https://learn.microsoft.com/windows/win32/api/objidl/ns-objidl-statstg#members">Read more on learn.microsoft.com</see>.</para>
			/// </summary>
			internal winmdroot.Foundation.PWSTR pwcsName;
			...
			/// <para><see href="https://learn.microsoft.com/windows/win32/api/objidl/ns-objidl-statstg#members">Read more on learn.microsoft.com</see>.</para>
			/// </summary>
			internal winmdroot.System.Com.STGM grfMode;

			private uint _grfLocksSupported;
			...
			internal LOCKTYPE grfLocksSupported
			{
				get => (LOCKTYPE)this._grfLocksSupported;
				set => this._grfLocksSupported = (uint)value;
			}
		}
	}
}
